                ...
                <li class="nav-item">
                    <a class="nav-link d-flex justify-content-between align-items-center"
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <span class="item-name ms-2">Friend</span>
                        </div>
                        ...
                        <div class="d-flex align-items-center">
                            ...
                            <span id="pendingBadge"
                                ...
                                style="font-size: 11px; padding: 4px 7px; border-radius: 10px; display: {{ $pendingCount > 0 ? 'inline-block' : 'none' }}">
                                {{ $pendingCount }}
                            </span>
                    ...
                    <ul class="sub-nav collapse" id="sidebar-special-friend" data-bs-parent="#sidebar-menu">
                        <li class="nav-item" style="margin-top: 10px;">
                             <a class="nav-link {{ request()->routeIs('friend') ? 'active' : '' }}" href="{{route('friend')}}">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i class="sidenav-mini-icon"> B </i>
                                <span class="item-name">My Friend</span>
                                <span id="pendingBadgeInner"
                                    class="badge bg-danger ms-2"
                                    style="font-size: 11px; padding: 4px 7px; border-radius: 10px; display: {{ $pendingCount > 0 ? 'inline-block' : 'none' }}">
                                    {{ $pendingCount }}
                                </span>
                        ...
                        <li class="nav-item" style="margin-top: 10px;">
                             <a class="nav-link {{ request()->routeIs('add_friend') ? 'active' : '' }}" href="{{route('add_friend')}}">
                                <i class="icon">
                                    <svg class="icon-10" xmlns="http://www.w3.org/2000/svg" width="10" viewBox="0 0 24 24" fill="currentColor">
                                        <g>
                                            <circle cx="12" cy="12" r="8" fill="currentColor"></circle>
                                ...
                                <i class="sidenav-mini-icon"> B </i>
                                <span class="item-name">Add Friend</span>
                            </a>
                        </li>
                    </ul>
                </li>
...
<script>
    function updateMenuBadge() {
        ...
        fetch("/friend/pending-count")
            .then(response => response.json())
            .then(data => {

                let badge1 = document.getElementById("pendingBadge");      
                let badge2 = document.getElementById("pendingBadgeInner");  
